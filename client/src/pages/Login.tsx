  ...
  return (
    <div className='h-screen w-full animated-background bg-gradient-to-r from-midnightp1 via-midnightp1 to-midnightp2 flex items-center justify-center'>
      <div className='flex justify-evenly w-full'>
        <div>
          <h1 className='text-5xl pb-20 text-midnightp2 font-bold'>Welcome back,</h1>
          <form onSubmit={onSubmitForm}>
            ...
            <br></br>
            <div>
              <button className='mt-3 py-2 px-4 rounded-2xl border-2 border-red-900 bg-black text-white hover:bg-red-950 hover:text-red-100 transition-colors duration-300'>Login</button>
            </div>
          </form>
          <p className='text-white pt-10'>Don't have an account?</p>
